...
Outputs from [Xenium Onboard Analysis (XOA)](https://www.10xgenomics.com/support/software/xenium-onboard-analysis/latest){target="_blank"} can be used to run [Xenium Ranger](https://www.10xgenomics.com/support/software/xenium-ranger/latest){target="_blank"}, as described [here](https://www.10xgenomics.com/support/software/xenium-ranger/latest/analysis/inputs/XR-input-overview){target="_blank"}.
