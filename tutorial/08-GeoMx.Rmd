...
NanoString Technologies (Now Bruker Corporation) provides a toolkit to process GeoMx readout in Fastq format. As described [here](https://cumulus.readthedocs.io/en/stable/geomxngs/index.html){target="_blank"}, users can follow the instruction and generate files with dcc as suffix for downstream analysis. 
...
A few example images from Quickomics exploration:
